...
public class PlaTestAutApiPost {
    static WebDriver driver;
    public PlaTestAutApiPost(WebDriver driver){
        this.driver = driver;
    }

    public void PlaTestAutApiPostXpath(WebDriver driver) {
        driver.get("https://triosdecapacitacao.eadplataforma.com/plano/plano-teste-automatizado-api-postman/");
        driver.get("https://triosdecapacitacao.eadplataforma.com/checkout/plan/9/");
