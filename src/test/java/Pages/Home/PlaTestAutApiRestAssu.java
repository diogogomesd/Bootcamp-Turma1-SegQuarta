...
public class PlaTestAutApiRestAssu {
    static WebDriver driver;
    public PlaTestAutApiRestAssu(WebDriver driver){
        this.driver = driver;
    }

    public void PlaTestAutApiRestAssuXpath(WebDriver driver) {
        driver.get("https://triosdecapacitacao.eadplataforma.com/plano/plano-testes-automatizados-api-rest/");
        driver.get("https://triosdecapacitacao.eadplataforma.com/checkout/plan/8/");
        driver.navigate().back();
        driver.get("https://triosdecapacitacao.eadplataforma.com/curso/teste-automatizado-na-aplicacao-api-rest-assured/");
        driver.get("https://triosdecapacitacao.eadplataforma.com/plano/plano-testes-automatizados-api-rest/");
        driver.get("https://triosdecapacitacao.eadplataforma.com/checkout/plan/8/");
        driver.navigate().back();
